...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertOrUpdateStockReportCashFlow]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertOrUpdateStockReportCashFlow]
GO
...
-- Revision:
-- =============================================
CREATE PROCEDURE [dbo].[InsertOrUpdateStockReportCashFlow]
@pStockNo VARCHAR(10), 
@pYear SMALLINT,
@pSeason SMALLINT,
@pDepreciation MONEY,
