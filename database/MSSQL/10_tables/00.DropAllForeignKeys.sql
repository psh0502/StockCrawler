...
GO
ALTER TABLE [dbo].[StockReportPerSeason] DROP CONSTRAINT [FK_StockReportPerSeason_Stock]
GO
ALTER TABLE [dbo].[StockReportPerMonth] DROP CONSTRAINT [FK_StockReportPerMonth_Stock]
GO
