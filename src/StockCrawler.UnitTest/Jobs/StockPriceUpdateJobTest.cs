    ...
    public class StockPriceUpdateJobTest : UnitTestBase
    {
        ...
        public void StockPriceUpdateTest()
        {
            ...
            using (var db = new StockDataContext(ConnectionStringHelper.StockConnectionString))
            {
                ...
                {
                    int? pageCount = null;
                    var data = db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, Services.SystemTime.Today, Services.SystemTime.Today, 1, 100, 1, 10, ref pageCount).ToList();
        ...
        public void StockPriceUpdateForSaturdayOrSundayNoDataOn0331Test()
        {
            ...
            Services.SystemTime.SetFakeTime(new DateTime(2020, 3, 30));
            {
                ...
                using (var db = new StockDataContext(ConnectionStringHelper.StockConnectionString))
                {
                    Assert.IsFalse(db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 3, 31), new DateTime(2020, 3, 31), 1, 100, 1, 10, ref pageCount).Any());
                    Assert.IsFalse(db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 3, 1), new DateTime(2020, 3, 1), 20, 100, 1, 10, ref pageCount).Any());
                }
            }
            ...
            using (var db = new StockDataContext(ConnectionStringHelper.StockConnectionString))
            {
                var data = db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 3, 1), new DateTime(2020, 3, 1), 20, 100, 1, 10, ref pageCount).ToList();
                Assert.AreEqual(1, data.Count);
                Assert.AreEqual(1, pageCount);
                var d1 = data.First();
                _logger.DebugFormat("StockNo={0}\r\nStockDT={1}\r\nOpenPrice={2}\r\nHighPrice={3}\r\nLowPrice={4}\r\nClosePrice={5}\r\nVolume={6}\r\nDeltaPrice={7}\r\nDeltaPercent={8}%\r\nPE={9}",
        ...
        public void StockPriceUpdateForSaturdayOrSundayNoDataOn0405Test()
        {
            ...
            Services.SystemTime.SetFakeTime(new DateTime(2020, 4, 2));
            {
                ...
                using (var db = new StockDataContext(ConnectionStringHelper.StockConnectionString))
                {
                    Assert.IsFalse(db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 4, 3), new DateTime(2020, 4, 3), 1, 100, 1, 10, ref pageCount).Any());
                    Assert.IsFalse(db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 3, 30), new DateTime(2020, 3, 30), 5, 100, 1, 10, ref pageCount).Any());
                }
            }
            ...
            using (var db = new StockDataContext(ConnectionStringHelper.StockConnectionString))
            {
                var data = db.GetStockPriceHistoryPaging(TEST_STOCK_NO_1, new DateTime(2020, 3, 30), new DateTime(2020, 3, 30), 5, 100, 1, 10, ref pageCount).ToList();
                Assert.AreEqual(1, data.Count);
                Assert.AreEqual(1, pageCount);
                var d1 = data.First();
                _logger.DebugFormat("StockNo={0}\r\nStockDT={1}\r\nOpenPrice={2}\r\nHighPrice={3}\r\nLowPrice={4}\r\nClosePrice={5}\r\nVolume={6}\r\nDeltaPrice={7}\r\nDeltaPercent={8}%\r\nPE={9}",
